...
import { arbitrum, polygon, optimism, bsc, mainnet } from "wagmi/chains";
...
import { setCurrentComponent, setLogout } from "@/store/userSlice";
import { nexisDevnet } from "./SwitchChainModal";
...
const usdTokens: UsdTokens = {
  [nexisDevnet.id]: "nexis-network-token",
...
const ConnectWallet = ({
  ...
  useEffect(() => {
    ...
    dispatch(
      fetchUsdPrice({
        tokenId: usdTokens[chain?.id ?? nexisDevnet.id],
        controller,
      })
    );
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="border border-[0.5px] border-gray-alpha-40 rounded-full bg-black p-1"
                />
